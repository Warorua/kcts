...
$_SESSION['two_auth_secret'] = $secret;
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
				...
				<div class="d-none" data-kt-element="apps">
					...
					<div class="text-gray-500 fw-semibold fs-6 mb-10">Using an authenticator app like
						...
						<div class="pt-5 text-center">
							<?php printf('<img src="%s" alt="" class="mw-150px"/>', $src_auth); ?>
						</div>
						<!--end::QR code image-->
					</div>
					<!--end::Description-->
						...
						<div class="d-flex flex-stack flex-grow-1">
							...
							<div class="fw-semibold">
								<div class="fs-6 text-gray-700">If you having trouble using the QR code, select manual entry on your app, and enter your username and the code:
									<div class="fw-bold text-dark pt-2"><?php echo $totp->getSecretReadable();; ?></div>
								</div>
							</div>
							<!--end::Content-->
						</div>
					...
					<!--end::Notice-->
					<!--begin::Form-->
					<form data-kt-element="apps-form" id="two_auth_qr" class="form">
						<!--begin::Input group-->
						<input type="hidden" name="secret" value="<?php echo $secret ?>" />
						<div class="mb-10 fv-row">
							<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Enter authentication code" name="code" required />
						</div>
						<!--end::Input group-->
						<!--begin::Actions-->
						<div class="d-flex flex-center">
							<button type="reset" data-kt-element="apps-cancel" class="btn btn-light me-3">Cancel</button>
							<button type="submit" data-kt-element="#" class="btn btn-primary">
				...
				<div class="d-none" data-kt-element="sms">
					...
					<!--end::Notice-->
					<!--begin::Form-->
					<form data-kt-element="sms-form" class="form" id="two_auth_sms" action="#">
						<!--begin::Input group-->
						<div class="mb-10 fv-row">
							<input class="form-control form-control-lg form-control-solid" placeholder="Mobile number with country code..." id="phoneNo" name="mobile" required />
							<div class="form-text">Phone number format:
								<code>(254) 712-345-678</code>
							</div>
						</div>
						<div class="mb-10 fv-row">
							<button type="button" id="smsCode" class="btn btn-success me-3">Request code</button>
						</div>
						<div class="mb-10 fv-row">
							<b class="text text-danger" id="authSmsErr"></b>
						</div>
						<div class="mb-10 fv-row">
							<input class="form-control form-control-lg form-control-solid" placeholder="Authentication code" id="codeNo" name="code" required disabled />
						</div>
						<!--end::Input group-->
						<!--begin::Actions-->
						<div class="d-flex flex-center">
							<button type="reset" data-kt-element="sms-cancel" class="btn btn-light me-3">Cancel</button>
							<button type="submit" id="codeSubmit" class="btn btn-primary" disabled>
								<span class="indicator-label">Submit</span>
								<span class="indicator-progress">Please wait...
									<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
							</button>
