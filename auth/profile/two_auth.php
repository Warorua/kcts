                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        ...
                        <div style="text-align:center; margin:0 60px 34px 60px">
                            ...
                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">Account superbly secured!</p>
                                <p style="margin-bottom:2px; color:#7E8299">Lots of people make mistakes and forget</p>
                                <p style="margin-bottom:2px; color:#7E8299">or lose their account passwords. Luckily, your</p>
                                <p style="margin-bottom:10px; color:#7E8299">account has been firmly secured.</p>
                                <b style="margin-bottom:2px; color:#7E8299">No Safety, Know Pain. Know Safety, No Pain.</b>
                            </div>
                            <!--end:Text-->
                            <!--begin:Action-->
                            <a target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">Two-Factor Authentication Activated!</a>
                            <!--end:Action-->
                        </div>
                        <!--end:Email content-->
                    </td>
...
}elseif(preg_replace('/[)(\@\.\;\" "-]+/', '', $code) == $_SESSION['mail_authCode']){
    $stmt = $conn->prepare("UPDATE users SET two_auth=:two_auth, two_auth_secret=:two_auth_secret WHERE id=:id");
    $stmt->execute(['id'=>$user['id'], 'two_auth'=>2, 'two_auth_secret'=>$_POST['mobile']]);
    $message = '
    <style>html,body { padding:0; margin:0; font-family: Inter, Helvetica, "sans-serif"; } a:hover { color: #009ef7; }</style>
    <div id="#kt_app_body_content" style="background-color:#F7F2EF; font-family:Arial,Helvetica,sans-serif; line-height: 1.5; min-height: 100%; font-weight: normal; font-size: 15px; color: #2F3044; margin:0; padding:0; width:100%;">
        <div style="background-color:#ffffff; padding: 45px 0 34px 0; border-radius: 24px; margin:40px auto; max-width: 600px;">
