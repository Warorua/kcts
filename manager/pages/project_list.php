...
<div class="col-lg-12">
  <div class="col-md-11 col-md-offset-10">
    ...
    <a class="col-sm-2 btn btn-md btn-info" href="#new_project" data-toggle="modal">
      <center><i class="fa fa-plus"></i> New Project</center>
    </a>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <?php if ($_GET['io'] == '3') {
        $btn_class2 = 'class="btn btn-md btn-success"';
      } else {
        $btn_class2 = 'class="btn btn-md btn-default"';
      } ?>
    ...
    <div class="panel-body">
      ...
      <table id="position" class="table table-bordered table-condensed">
        ...
        <tbody>
          ...
          $query =  mysqli_query($conn2, "SELECT * FROM projects where io = '" . $_GET['io'] . "'");;
          ...
          ?>
            <tr>
              ...
              <td style="text-transform:capitalize" class="text-center"><?php echo $row['settings_name'] ?></td>
              ...
              <td style="text-transform:capitalize" class="text-center">
                <center><a href="index.php?page=project_detail&id=<?php echo $id ?>&stats=<?php echo $_GET['io'] ?>"><i class="fa fa-eye"></i> View </a></center>
              </td>
            </tr>
