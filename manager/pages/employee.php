    ...
    <div class="panel-body">
      ...
      <table id="emp" class="table table-bordered table-condensed">
        ...
        <tbody>
          ...
          $query =  mysqli_query($conn2, "SELECT *,CONCAT(last_name,', ',first_name,' ',midname) as name FROM employee natural join position where io = '" . $_GET['io'] . "' and eid != 1 order by name ");
          ...
          ?>
            <tr>
              ...
              <td style="text-transform:capitalize" class="text-center">
                <center><a href="index.php?page=employee_profile&id=<?php echo $id ?>"><i class="fa fa-eye"></i> Profile</a></center>
              </td>
            </tr>
...
<div class="col-md-2">
  ...
  <a class="col-sm-12 btn btn-md btn-info" href="#new_employee" data-toggle="modal">
    <center><i class="fa fa-plus"></i>New Employee</center>
  </a>
</div>
<div id="retCode1"></div>
