      ...
      <div class="modal-content modal-md">
        ...
        <div class="modal-body">
          ...
          <div class="form-horizontal">
            ...
            ?>
            <div id="retCode1">
              <div class="alert alert-success" id="msg20"><i class="fa fa-check"></i> Data successfully updated. </div>
            </div>
            <div id="retCode1">
              <div class="alert alert-danger" id="msg21"><i class="fa fa-check"></i> Password is Incorrect. </div>
            </div>
          ...
          <br>
          <div class="form-group">
            <div class="col-sm-4 text-right"><label for="us">Email:</label></div>
            <div class="col-sm-8">
              <input type="text" class="form-control input-sm" id="us" value="<?php echo $row2['email'] ?>" name="user">
            </div>
          </div>
          <br>
          <br>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" style="text-transform:capitalize" id="pp" required>
                  <option selected="" disabled=""></option>
                  <?php
                  $pp = mysqli_query($conn2, "SELECT * FROM projects order by settings_name ASC ");
                  while ($pp_row = mysqli_fetch_assoc($pp)) {
                  ?>
                    <option value="<?php echo $pp_row['id'] ?>"><?php echo ucwords($pp_row['settings_name']) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" style="text-transform:capitalize" id="reid" required>
                  <option selected="" disabled=""></option>
                  <?php
                  $pp = mysqli_query($conn2, "SELECT *,CONCAT(last_name,', ',first_name,' ',midname) as name FROM employee natural join position where position = 'foreman' ");
                  while ($pp_row = mysqli_fetch_assoc($pp)) {
                  ?>
