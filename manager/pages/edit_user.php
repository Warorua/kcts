<center><h4>Edit User</h4></center>
  <?php
    include '../includes/db.php';
      ...
      $query2=  mysqli_query($conn2, "SELECT *,CONCAT(lastname,', ',firstname,' ',midname) as name,users.io as status FROM users left join employee on users.eid = employee.eid where uid = '".$_GET['uid']."' ");
