		...
		<div class="panel-body">
			...
			<div class="col-md-9">
				<div class="row form-group">
					...
					<label class="control-label" style="font-size:20px !important"><?php echo $row['settings_name'] ?></label>
				</div>
				<hr>
				<div class="col-md-6">
					<div class="row form-group">
						<label class="control-label">Start Date:</label>
						<label class="control-label"><?php echo date("F d, Y", strtotime($row['settings_release_date'])) ?></label>
					</div>
					<div class="row form-group">
				...
				<div class="col-md-6">
					...
					<?php if (!isset($_GET['dattyp'])) { ?>
						...
						<div class="row form-group">
							...
							<label class="control-label"><?php if ($row['stats'] == '1') {
																echo 'On going';
															} elseif ($row['stats'] == '2') {
																echo 'Finished';
															} elseif ($row['stats'] == '3') {
					...
					<div class="row form-group">
						...
						<?php
						$sql = mysqli_query($conn2, "SELECT * from project_partition natural join project_division where project_id = '$id' order by division ");
						$i = 0;
