...
<div class="col-lg-7">
    ...
    include '../includes/db.php';
      ...
      $query=  mysqli_query($conn2, "SELECT *,CONCAT(last_name,', ',first_name,' ',midname) as name FROM users left join employee on users.id=employee.eid where users.io = '".$_GET['io']."' and users.id != '".$_SESSION['ID']."' ");
 ...
 <center><h4>New User</h4></center>
  ...
  <div class="alert alert-success" id="msg"><i class="fa fa-check"></i> Data successfully added. </div>
    ...
    include '../includes/db.php';
      ...
      $query2=  mysqli_query($conn2, "SELECT *,CONCAT(last_name,', ',first_name,' ',midname) as name FROM employee where io = '1' and eid != '".$_SESSION['ID']."' order by name ");
