...
CREATE TABLE `projects` (
  ...
  `budget_setup` varchar(10) NOT NULL,
...
INSERT INTO `projects` (`project_id`, `project`, `location`, `budget_setup`, `start_date`, `deadline`, `site_pic`, `tid`, `proposed_project`, `date_added`, `io`) VALUES
