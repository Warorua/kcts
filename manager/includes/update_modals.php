        ...
        <div class="modal-body">
          ...
          <div class="col-md-12">
            <div class="alert alert-success" id="suc_msg">
              <h4><i class="fa fa-check"></i> Image successfully updated.</h4>
            </div>
          </div>
          ...
          <div class="form-horizontal">
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                ...
                <?php
                $div = mysqli_query($conn2, "SELECT * FROM project_partition natural join project_division where project_id = '$id' and pp_id != '" . $row2['pp_id'] . "' order by division ");
                while ($div_row = mysqli_fetch_assoc($div)) {
                  $test = mysqli_query($conn2, "SELECT sum(progress) as prog FROM project_progress where pp_id = '" . $div_row['pp_id'] . "' ");
          ...
          <div class="form-horizontal">
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                ...
                <input class="form-control" style="text-transform:capitalize" id="" name="lname" type="text" value="<?php echo $emp_row['last_name'] ?>" required>
              </div>
            </div>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <input class="form-control" style="text-transform:capitalize" id="" name="fname" type="text" value="<?php echo $emp_row['first_name'] ?>" required>
              </div>
            </div>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" style="text-transform:capitalize" id="" name="position" type="text" required>
                  ...
                  <?php
                  $pos_query = mysqli_query($conn2, "SELECT * FROM position where pid != '" . $emp_row['pid'] . "' order by position ASC");
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" id="" name="ps" type="text" required>
                  ...
                  ?>
                  <option value="<?php echo $emp_row['io'] ?>">
                    <?php
                    if ($emp_row['io'] == '1') {
                      echo 'Active';
                    } else {
    ...
    <div class="modal-content modal-md">
      ...
      <form method="POST" id='proj_form'>
        <div class="modal-body">
          ...
          $query_proj = mysqli_query($conn2, "SELECT *,CONCAT(last_name,', ',first_name,' ',midname) as name,projects.io as status from projects left join project_team on projects.tid = project_team.tid left join employee on project_team.eid = employee.eid  where id = '$id' ");
          ...
          <div class="form-horizontal">
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                ...
                foreach ($projectTypes as $row) {
                  ...
                  if ($row['id'] == $prow['proposed_project']) {
                    echo '<option id="p_typ" value="' . $row['id'] . '" selected>' . $row['title'] . '</option>';
                  }
                }
                ?>
                </select>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <input class="form-control" style="text-transform:capitalize" id="" name="pname" type="text" value="<?php echo $prow['settings_name'] ?>" required>
              </div>
            </div>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-6">
                <input class="form-control" style="text-align:right" id="cc" name="cost" type="text" placeholder="KES." value="<?php echo $prow['budget_setup'] ?>">
              </div>
            </div>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <input class="form-control" id="" name="sdate" type="date" value="<?php echo $prow['settings_release_date'] ?>" required>
              </div>
            </div>
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" id="" name="tid" type="text" required>
                  ...
                  <?php
                  include '../includes/db.php';
                  $pos_query = mysqli_query($conn2, "SELECT *,Concat(last_name,', ',first_name,' ',midname) as name FROM project_team left join employee on project_team.eid = employee.eid where project_team.eid != '" . $prow['eid'] . "' order by name ASC");
                  while ($pos_row = mysqli_fetch_assoc($pos_query)) {
                  ?>
    ...
    jQuery("#update_pos").submit(function(e) {
      ...
      $.ajax({
        ...
        success: function(html) {
          ...
          var delay = 1500;
          setTimeout(function() {
            window.location = 'index.php?page=position';
          }, delay);
