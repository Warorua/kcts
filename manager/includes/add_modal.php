            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" id="" name="position" type="text" required>
                  ...
                  $pos_query = mysqli_query($conn2, "SELECT * FROM position order by position ASC");
            ...
            <div class="form-group" id="form-login">
              ...
              <div class="col-sm-8">
                <select class="form-control" id="tid" name="tid" type="text" onchange="mem_list()" required>
                  ...
                  <?php
                  include '../includes/db.php';
                  $pos_query = mysqli_query($conn2, "SELECT *,Concat(last_name,', ',first_name,' ',midname) as name FROM project_team left join employee on project_team.eid = employee.eid where pio='1' order by name ASC");
                  while ($pos_row = mysqli_fetch_assoc($pos_query)) {
                  ?>
