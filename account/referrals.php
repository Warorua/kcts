						...
						<div class="card mb-5 mb-xl-10">
							...
							<div class="card-body py-10">
								...
								<div class="row">
									...
									<div class="col">
										<div class="card card-dashed flex-center min-w-175px my-3 p-6">
											<span class="fs-4 fw-semibold text-danger pb-1 px-2">App Earnings</span>
											<span class="fs-lg-2tx fw-bold d-flex justify-content-center">PTS.
												<span data-kt-countup="true" data-kt-countup-value="<?php echo $my_earn['app'] ?>">0</span></span>
										</div>
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col">
										<div class="card card-dashed flex-center min-w-175px my-3 p-6">
											...
											<span class="fs-lg-2tx fw-bold d-flex justify-content-center">PTS.
												<span data-kt-countup="true" data-kt-countup-value="<?php echo $my_earn['refer'] ?>">0</span></span>
										</div>
									</div>
									<!--end::Col-->
								</div>
									...
									<div class="table-responsive">
										...
										<table class="table table-row-bordered table-flush align-middle gy-6">
											...
											<tbody class="fs-6 fw-semibold text-gray-600">
												<?php
												$stmt = $conn->prepare("SELECT * FROM users WHERE referer_id=:id");
												$stmt->execute(['id' => $user['id']]);
												$refers = $stmt->fetchAll();
												foreach ($refers as $row) {
												?>
													<tr>
														<td class="ps-9 d-flex align-items-center">
															<!--begin:: Avatar -->
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="view.html">
																	<div class="symbol-label">
																		<img src="<?php echo  pic_fix($row['photo'])  ?>" alt="<?php echo  $row['username']  ?>" class="w-100" />
																	</div>
																</a>
															</div>
															<!--end::Avatar-->
															...
															<div class="d-flex flex-column">
																<a href="view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo  $row['username']  ?></a>
																<span><?php echo  $row['t_id']  ?></span>
															</div>
															<!--begin::User details-->
														</td>
														<td class="ps-0">
															<a class="text-gray-600 text-hover-primary"><?php echo  $row['country']  ?></a>
														</td>
														<td><?php echo $row['created_on'] ?></td>
														<td>0%</td>
														<td class="text-success">PTS.100.00</td>
													</tr>
												<?php
												}
												?>
