                                                        ...
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?php echo $filePathScript ?>assets/media/svg/avatars/blank.svg')">
                                                                    ...
                                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url(<?php echo $filePathScript ?>assets/media/avatars/300-6.jpg);"></div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        ...
                                        foreach ($users as $row) {
                                            if ($row['two_auth'] == 0) {
                                                $two_auth_badge = '<div class="badge badge-light-danger fw-bolder">Disabled</div>';
                                            } else {
                                                $two_auth_badge = '<div class="badge badge-light-success fw-bolder">Enabled</div>';
                                            }
                                            if (searchEntity(systemRoles(), $row['role'], 'title') == 'UNKNOWN') {
                                                $role_badge = 'NOT SET';
                                            } else {
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                    <a href="view.html">
                                                        <div class="symbol-label">
                                                          '.userProfileHolder($row['firstname']).'
                                                        </div>
                                                    </a>
                                                </div>
                                                <!--end::Avatar-->
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="view.html" class="text-gray-800 text-hover-primary mb-1">' . $row['firstname'] . ' ' . $row['lastname'] . '</a>
                                                    <span>' . $row['email'] . '</span>
                                                </div>
                                                <!--begin::User details-->
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="' . $filePathScript . 'users/view/' . $row['id'] . '" class="menu-link px-3">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
