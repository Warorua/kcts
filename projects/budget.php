						...
						<div class="card mb-6 mb-xl-9">
							<div class="card-body pt-9 pb-0">
								...
								<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
									...
									<!--begin::Nav item-->
									<li class="nav-item">
										<a class="nav-link text-active-primary py-5 me-6 active" href="<?php echo $filePathScript ?>project/budget/<?php echo $last_segment ?>">Communication</a>
									</li>
									<!--end::Nav item-->
									<!--begin::Nav item-->
									<li class="nav-item">
										...
										<div class="card-header pt-9">
											...
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-50px me-5">
													<img src="../<?php echo $filePathScript ?>assets/media/avatars/300-7.jpg" class="" alt="">
												</div>
												<!--end::Avatar-->
												<!--begin::Info-->
										...
										<div class="card-footer pt-0">
												...
												<div class="collapse show" id="kt_social_feeds_comments_2" style="">
													...
													<div class="d-flex pt-6">
														...
														<div class="symbol symbol-45px me-5">
															<img src="../<?php echo $filePathScript ?>assets/media/avatars/300-13.jpg" alt="">
														</div>
														<!--end::Avatar-->
														<!--begin::Wrapper-->
													...
													<div class="d-flex pt-6">
														<!--begin::Avatar-->
														<div class="symbol symbol-45px me-5">
															<img src="../<?php echo $filePathScript ?>assets/media/avatars/300-20.jpg" alt="">
														</div>
														<!--end::Avatar-->
														<!--begin::Wrapper-->
														<div class="d-flex flex-column flex-row-fluid">
											...
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-35px me-3">
													<img src="../<?php echo $filePathScript ?>assets/media/avatars/300-3.jpg" alt="">
												</div>
												<!--end::Author-->
												<!--begin::Input group-->
