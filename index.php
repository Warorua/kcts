	...
	<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
       ...
       <div class="fs-5 text-muted fw-bold">Engage actively with Kakamega County's procurement and projects. Access transparent information, participate in procurement,<br> and track ongoing initiatives. Be a part of accountable development for the community.</div>
							<!--end::Title-->
							<!--begin::Action-->
							<a href="index.html" class="btn btn-primary m-12" style="background-color: #2c2617;">Learn More</a>
							<!--end::Action-->
						</div>
						<!--end::Heading-->
						<!--begin::Clients-->
			...
			<div class="mt-sm-n10">
				...
				<!--end::Curve top-->
				<!--begin::Wrapper-->
				<div class="pb-2 pt-18 landing-dark-bg">
					<!--begin::Container-->
					<div class="container">
